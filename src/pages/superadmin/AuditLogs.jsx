  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between mb-8">
        ...
        >
          <div
            className={clsx("p-2 rounded-full bg-white/5", threatStatus.color)}
          >
            <ThreatIcon size={24} />
          </div>
          <div>
      ...
      <div className="grid gap-4 xl:grid-cols-4 mb-8">
        <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-5 backdrop-blur-sm">
          <div className="text-sm text-slate-400 font-medium flex items-center gap-2 mb-2">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2 mb-1">
                        ...
                        {!category.isConfidential && (
                          <span
                            className={clsx(
                              "flex items-center gap-1 px-2 py-0.5 rounded text-[10px] uppercase font-bold tracking-wider bg-slate-950 border border-slate-800",
                              severity.color,
                            )}
                          >
                      ...
                      <div className="mt-4 flex flex-wrap gap-2">
                        {log.user_email && (
                          <div className="px-2.5 py-1 rounded-md bg-slate-950 border border-slate-800 text-xs text-slate-400">
                            <span className="text-slate-600 mr-1">Actor:</span>
                            {category.isConfidential
                              ? "***@***.***"
                              : log.user_email}
                          </div>
                        ...
                        {log.tenant_name && (
                          <div className="px-2.5 py-1 rounded-md bg-slate-950 border border-slate-800 text-xs text-slate-400">
                            <span className="text-slate-600 mr-1">Tenant:</span>
                            {log.tenant_name}
                          </div>
                        )}
                        {log.ip_address && !category.isConfidential && (
                          <div className="px-2.5 py-1 rounded-md bg-slate-950 border border-slate-800 text-xs text-slate-400">
                            <span className="text-slate-600 mr-1">IP:</span>
                            {log.ip_address}
                          </div>
                        )}
