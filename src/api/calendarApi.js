...
export const createDayType = (data) =>
  axiosInstance.post(`${DAY}/uploadday`, data);

/** DELETE /v1/day/deleteday/:id — delete a day type */
export const deleteDayType = (id) =>
  axiosInstance.delete(`${DAY}/deleteday/${id}`);

/** PATCH /v1/day/updateday/:id — update a day type */
export const updateDayType = (id, data) =>
  axiosInstance.patch(`${DAY}/updateday/${id}`, data);

/** GET /v1/calendar-days/day-types/available  — slim list for dropdowns */
export const getAvailableDayTypes = () =>
  axiosInstance.get(`${CD}/day-types/available`);

// ── Year ────────────────────────────────────────────────────────────
export const getYears = () => axiosInstance.get("/v1/year/getyear");
export const createYear = (data) =>
  axiosInstance.post("/v1/year/uploadyear", data);
...
// ── Day Category ───────────────────────────────────────────────────
export const getDayCategories = (year_id) =>
  axiosInstance.get("/v1/day-category", { params: { year_id } });
export const createDayCategory = (data) =>
  axiosInstance.post("/v1/day-category", data);
export const deleteDayCategory = (id) =>
  axiosInstance.delete(`/v1/day-category/${id}`);
export const updateDayCategory = (id, data) =>
  axiosInstance.patch(`/v1/day-category/${id}`, data);
